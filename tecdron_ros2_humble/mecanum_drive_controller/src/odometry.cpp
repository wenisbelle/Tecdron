                                  ...
                                  double rear_right_vel, const rclcpp::Time& time)
{
  ...
  const double angular = (-front_left_vel + front_right_vel - rear_left_vel + rear_right_vel) / (4. * (wheel_separation_x_ + wheel_separation_y_));
...
void Odometry::integrateExact(double linear_x, double linear_y, double angular)
{
  ...
  {
    /// Exact integration (should solve problems when angular is not zero):
