...
#include "tecdron_controller/tecdron_controller.hpp"
...
namespace tecdron_controller
{
TecdronController::TecdronController() : controller_interface::ControllerInterface() {}


CallbackReturn TecdronController::on_init() {
  try {
...
CallbackReturn TecdronController::on_configure(
...
controller_interface::InterfaceConfiguration TecdronController::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration TecdronController::state_interface_configuration() const
{
...
CallbackReturn TecdronController::on_activate(const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn TecdronController::on_deactivate(const rclcpp_lifecycle::State & /*previous_state*/)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::return_type TecdronController::update(const rclcpp::Time &time,
...
PLUGINLIB_EXPORT_CLASS(tecdron_controller::TecdronController, controller_interface::ControllerInterface)