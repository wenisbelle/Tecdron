...
% PRECISO APLICAR O zoh APÓS AS SAÍDAS DO CONTROLADOR. 
% aproximar por padé (1-0.5*ts)/(1+0.5*ts)

Feedback = sumblk('e = r-y',3);

Planta=connect(Plant,In,K,w_e1,w_e2,w_e3,w_u1,w_u2,w_u3,w_u4,Feedback,{'r'},{'pond_e1','pond_e2','pond_e3','pond_u1','pond_u2','pond_u3','pond_u4','u(1)', 'u(2)','u(3)','u(4)','y'});
